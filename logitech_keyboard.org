...
#+begin_src kbdx
lshift = (around (layer-toggle qwerty) lshift)
rshift = (around (layer-toggle qwerty) rshift)
...
TASKWARRIOR_TUI = "~/.local/bin/taskwarrior-tui"
#+end_src
