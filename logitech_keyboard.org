...
#+begin_src kbd -r
(defalias
  win (cmd-button "~/.local/bin/rofi -noplugins -modi window -show window -lines 5 --normal-window") ;; window switcher - layer? (ref:window-switcher)
  dsc (cmd-button "wmctrl -a discord || /usr/bin/Discord") ;; (ref:discord)
