...
*You can view the HTML-exported version of both the documentation and the configuration [[./index.html][here]]*. GitHub's rendering of Org documents is not perfect, so the HTML version is better-suited for in-browser reading
